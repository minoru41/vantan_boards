...
if (!empty($_POST['title'])) {
    ...
    if($result) {
        $message = '掲示板を作成しました';
        header('Location: /vantan_boards/board.php?id=' . $pdo->lastInsertId());
        exit;
    } else {
        $message = '登録に失敗しました';
    }
...
<header>
    <div>
        ...
        <a href="/vantan_boards/create_board.php">掲示板作成</a>
    </div>
    <h1>掲示板新規作成</h1>
</header>
<div>
    ...
    <form action="/vantan_boards/create_board.php" method="post">
